...
`
export const LabelFormed = styled.label`
display:none;
position:absolute;
width: max-content;
font-size:12px;
...
opacity: .4;
`;
export const IconScrh = styled.img`
position: absolute;
left:40px;
top:16px;
width: 20px;
...
`;
export const ClearButtoned = styled.button`
width: 30px;
  height: 16px;
...
export const Inner = styled.li.attrs<Props>(({ tabIndex }) => ({
  ...
  &:active {
    border: 1px solid ${({ theme }) => theme.colors.border.borderActive};
